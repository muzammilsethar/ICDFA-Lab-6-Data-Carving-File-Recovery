...
wget https://www.dropbox.com/s/nw23q14vzs3ykup/Ch01InChap01.dd -O Ch01InChap01.dd
wget https://raw.githubusercontent.com/frankwxu/digital-forensics-lab/main/Basic_Computer_Skills_for_Forensics/file_carving/usb_file/J_ub_law.jpg -O J_ub_law.jpg
wget https://raw.githubusercontent.com/frankwxu/digital-forensics-lab/main/Basic_Computer_Skills_for_Forensics/file_carving/usb_image/120M.7z -O 120M.7z

# Verify evidence integrity
md5sum Ch01InChap01.dd J_ub_law.jpg 120M.7z
sha256sum Ch01InChap01.dd J_ub_law.jpg 120M.7z

![Step 1 Setup](lab6%20data%20crving%201.png)

#### Technical Data Output & Findings:
* **Ch01InChap01.dd MD5:** `a11773bcf1fc088ec0ab8e0a349ffbcb`
* **Ch01InChap01.dd SHA-256:** `3ce8053e4f3d9c8ab98b3aadb2480685efb4e4980d34297b83bd5a09b1a7b122`
...
![Step 2 File System Analysis](lab%206%20data%20criving%2014d.png)
...
* **Raw Cluster Data:** Extracted database schema tables (`MSysRelationships`, `MSysQueries`).
...
![Step 3 Hex Dump](lab%206%20data%20criving%207.png)

![Step 3 EXIF Strings](lab%206%20data%20criving%208.1.png)
...
| **J_ub_law.jpg** | Metadata Extraction | `strings` | Extracted NIKON D4 & Howard Krup EXIF/XMP data. |
